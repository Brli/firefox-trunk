                     ...
                     nsIContent *aMenuBar)
{
  ...
  uGlobalMenuService::RegisterGlobalMenuBar(this, mCancellable);
...
void
uGlobalMenuBar::SetXULMenuBarHidden(bool hidden)
{
...
void
uGlobalMenuBar::SetMenuBarRegistered(bool aRegistered)
{
  if (mCancellable) {

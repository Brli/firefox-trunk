...
static const mozilla::Module::CIDEntry kGlobalMenuCIDs[] = {
    { &kU_GLOBALMENUSERVICE_CID, false, NULL, uGlobalMenuServiceConstructor },
    { &kU_GLOBALMENULOADER_CID, false, NULL, uGlobalMenuLoaderConstructor },
    { NULL }
};

static const mozilla::Module::ContractIDEntry kGlobalMenuContracts[] = {
    { U_GLOBALMENUSERVICE_CONTRACTID, &kU_GLOBALMENUSERVICE_CID },
    { U_GLOBALMENULOADER_CONTRACTID, &kU_GLOBALMENULOADER_CID },
    { NULL }
};
